/*
Скрипт развертывания для ImNotAlcogolic
...
GO
:setvar DatabaseName "ImNotAlcogolic"
:setvar DefaultFilePrefix "ImNotAlcogolic"
:setvar DefaultDataPath "D:\библиотеки\Downloads\MSSQL14.MSSQLSERVER\MSSQL\DATA\"
:setvar DefaultLogPath "D:\библиотеки\Downloads\MSSQL14.MSSQLSERVER\MSSQL\DATA\"
...
GO
PRINT N'Выполняется создание [dbo].[Country]...';
...
GO
PRINT N'Выполняется создание [dbo].[Customers]...';
...
GO
PRINT N'Выполняется создание [dbo].[ProductCategory]...';
...
CREATE TABLE [dbo].[ProductCategory] (
    ...
    PRIMARY KEY CLUSTERED ([CategoryID] ASC, [ProductID] ASC)
);


GO
PRINT N'Выполняется создание [dbo].[Suppliers]...';
...
GO
PRINT N'Выполняется создание ограничение без названия для [dbo].[Suppliers]...';


GO
ALTER TABLE [dbo].[Suppliers]
    ADD FOREIGN KEY ([CountryID]) REFERENCES [dbo].[Country] ([Id]);
